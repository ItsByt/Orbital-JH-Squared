...
describe("useTimetableActions", () => {
  ...
  describe("handleSelectClass", () => {
    it("clears alternatives when the already selected class is clicked again", () => {
      const selectedLesson = createMockLesson({ id: "lesson-1" as unknown as DisplayLesson["id"] });
      ...
      act(() => {
        result.current.handleSelectClass(createMockLesson({ id: "lesson-1" as unknown as DisplayLesson["id"] }));
      });
    ...
    it("selects module to compare when a new class is clicked", () => {
      ...
      const newLesson = createMockLesson({ id: "lesson-2" as unknown as DisplayLesson["id"] });
      act(() => {
  ...
  describe("handleSwapClass", () => {
    ...
    it("swaps class and retains the old lesson color", async () => {
      const oldLesson = createMockLesson({ id: "old-id" as unknown as DisplayLesson["id"], color: "#123456" });
      const alternative = createMockLesson({ id: "alt-id" as unknown as DisplayLesson["id"], color: "#ffffff" });
  ...
  describe("handleAddModule", () => {
    it("shows error toast if module is a duplicate (non-custom)", async () => {
      const activeLessons = [createMockLesson({ moduleCode: "CS1010S", id: "nusmod-1" as unknown as DisplayLesson["id"] })];
      const { result } = renderHook(() =>
        useTimetableActions(
          currentSemester,
          null,
    ...
    it("allows adding duplicate module code if existing entry is a personal/custom block", async () => {
      const activeLessons = [createMockLesson({ moduleCode: "CS1010S", id: "custom-123" as unknown as DisplayLesson["id"] })];
    ...
    it("adds module to DB, invalidates query, and toasts success", async () => {
      const mockTimetable = [{ lessonType: "Lecture", classNo: "1" as unknown as DisplayLesson["classNo"] }];
      vi.mocked(getModule).mockResolvedValue({
        moduleCode: "CS1010S",
  ...
  describe("handleUpdateColor", () => {
    it("optimistically updates regular module color in query cache and saves to DB", async () => {
      ...
      const oldLessons = [
        createMockLesson({ id: "1" as unknown as DisplayLesson["id"], moduleCode: "CS1010S", color: "#ff0000" }),
        createMockLesson({ id: "2" as unknown as DisplayLesson["id"], moduleCode: "MA1521", color: "#0000ff" }),
      ];
