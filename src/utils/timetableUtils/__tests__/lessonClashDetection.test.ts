...
const baseLesson: DisplayLesson = {
    id: '1', moduleCode: 'CS2040S', lessonType: 'LEC', classNo: '1', day: 'Monday',
    startTime: '1000', endTime: '1200', venue: 'LT1', startMins: 600, endMins: 720,
    weekBitmask: 1, isAlternative: false, weeks: [1]
};
...
describe('Lesson Clash Detection', () => {
    ...
    it('should detect schedule clash for overlapping times on same day and same week', () => {
        const other = { ...baseLesson, startTime: '1100', endTime: '1300', startMins: 660, endMins: 780 };
